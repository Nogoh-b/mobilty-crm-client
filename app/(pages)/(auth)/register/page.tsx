    ...
    <>
		...
		<div className="container vh-100">
			<div className="welcome-area">
				{/* <div className="bg-image bg-image-overlay" style="background-image: url(assets/images/login/pic3.jpg);"></div> */}
				...
				<div className="join-area">
					...
					<form>
						...
						<div className="mb-3 input-group input-group-icon">
							...
							<input type="password" className="form-control dz-password" placeholder="Password"/>
					...
					<a href="login.html" className="btn btn-primary btn-block mb-3">REGISTER</a>
					<div className="d-flex align-items-center justify-content-center">
						<a href="javascript:void(0);" className="text-light text-center d-block">Don’t have an account?</a>
						<a href="login.html" className="btn-link d-block ms-3 text-underline">Signin here</a>
					</div>
				</div>
			</div>
		</div>
